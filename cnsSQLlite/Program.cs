...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        cmdDB.CommandText = "INSERT INTO Users (name,age) VALUES ('Mike',21)";
        cmdDB.ExecuteNonQuery();

        cmdDB.CommandText = "INSERT INTO Users (name,age) VALUES (@name,@age)";
        cmdDB.Parameters.Add(new("@name", "Oleg"));
        cmdDB.Parameters.Add(new("@age", "3"));
        cmdDB.ExecuteNonQuery();
        cmdDB.Parameters.Clear();

        cmdDB.CommandText = "INSERT INTO Users (name,age) VALUES ('Andr,16), SELECT last_insert_rowid()";
        Console.WriteLine($"id new obj={cmdDB.ExecuteScalar()}");
